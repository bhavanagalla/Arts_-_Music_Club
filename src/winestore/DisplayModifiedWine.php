...
//wine table
$showiTable="SELECT wine_id,wine_name,wine_type,year,winery_id,lastmodified FROM wine ORDER BY lastmodified DESC LIMIT 5";
$resulti=mysql_query($showiTable) or die(mysql_error());
...
while($info = mysql_fetch_array($resulti))
	{
